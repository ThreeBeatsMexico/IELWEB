...
{
    public partial class ReporteBusqueda : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "myScript", "setUrl('ContentPane','../Reportes/Transacciones.aspx','" + CreaTokenPost() + "');", true);
            }
            catch (Exception E)
            {

                throw new Exception("Mensaje:BuscaReporte>BuscarDocumentos>Click");
            }
        }
        ...
        private string TokenPostXML()
        {
            ...
            sXML.Append("<APP>");
            sXML.Append("<FechaInicial>" + string.Format("{0:dd/MM/yyyy}", FechaInicial.SelectedDate) + "</FechaInicial>");
            sXML.Append("<FechaFinal>" + string.Format("{0:dd/MM/yyyy}", FechaFinal.SelectedDate) + "</FechaFinal>");
